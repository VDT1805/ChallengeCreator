      ...
      {auth.user ? (
        <>
          ...
          <div className="flex max-w-[980px] flex-col items-start gap-2">
            ...
            <Button asChild>
              <Link href={route('dashboard')} className="font-semibold text-white-600 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                Go to dashboard
              </Link>
            </Button>
          </div></>
